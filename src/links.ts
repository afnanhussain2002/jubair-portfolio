...
const LINKS: { [key in SocialMedia]: Link } = {
  behance: {
    title: 'Behance',
    icon: behance,
    link: 'https://www.behance.net/pixelencor',
    text: '@pixelencor',
  },
 /*  buymeacoffee: {
  ...
  instagram: {
    title: 'Instagram',
    icon: instagram,
    link: 'https://www.instagram.com/pixelencor/',
    text: '@pixelencor',
  },
 /*  kofi: {
    title: 'Ko-fi',
  ...
  linkedin: {
    title: 'Linkedin',
    icon: linkedin,
    link: 'https://www.linkedin.com/in/pixelencor/',
    text: '@pixelencor',
  },
 /*  medium: {
    title: 'Medium',
  ...
  tiktok: {
    title: 'Tiktok',
    icon: tiktok,
    link: 'https://www.tiktok.com/@pixelencore',
    text: '@pixelencore',
  },
  /* twitch: {
    title: 'Twitch',
