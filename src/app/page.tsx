  ...
  return (
    <div className="text-foreground relative mx-auto h-full w-[700px] max-w-full p-8 md:p-16 xl:w-[1400px]">
      <div className="mb-12 w-full xl:fixed xl:mb-0 xl:w-[500px]">
        ...
        <div className="mt-8">
          <h2 className="font-heading text-3xl sm:text-[44px]">JUBAIR AHMED
          </h2>
          <p className="font-base mt-6 text-base sm:text-xl">
          <span className="font-bold text-2xl text-main">Graphic designer</span>. Visual thinker. Detail lover. Turning ideas into bold, beautiful designs one pixel at a time.
          </p>
        </div>
